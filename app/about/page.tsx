    ...
    <main>
      ...
      <section className="aboutStory wrap">
        <div>
          ...
          <p>Kassidy grew up on her family farm, <a className="textLink" href="https://boarsrockfarm.ca" target="_blank" rel="noopener noreferrer">Boars Rock Farm ↗</a>, just outside Rocklyn, Ontario. Years of watching her parents work hard, sacrifice, and grow thriving businesses from their passions helped fuel her own love for working outside and building something to be proud of.</p>
